...
$sql = "SELECT user.user_name, user.user_image, location_review.review_rate, location_review.review_content, location_review.review_reg_date FROM location_review"
		." INNER JOIN user ON location_review.user_idx = user.user_idx WHERE location_review.location_idx = $_GET[location_idx] ORDER BY location_review.review_reg_date DESC LIMIT $_GET[start] , 3";
