...
public class ReservationCalendarAdapter extends BaseAdapter {
    ...
    public ReservationCalendarAdapter(Context context, ArrayList<DayInfo> dayInfoArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(dayInfo.isInCourse()) {
            dayViewHolder.textViewDay.setTextColor(context.getResources().getColor(R.color.colorLightBlack));
            dayViewHolder.relativeLayouttDay.setBackground(context.getResources().getDrawable(R.drawable.gridview_calender_frame));
        }
